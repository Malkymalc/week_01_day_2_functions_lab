...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    eight_cm3_cube = volume_of_cube(2)
    assert_equal(8, eight_cm3_cube)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    three_cm_radius_sphere = volume_of_sphere(3)
    assert_equal(84.82, three_cm_radius_sphere)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius_zero()
    zero_celcius = fahrenheit_to_celsius(32)
    assert_equal(0, zero_celcius)
  end

  def test_fahrenheit_to_celsius_book()
    book_in_celcius_exact = fahrenheit_to_celsius(451, 5)
    assert_equal(232.77778, book_in_celcius_exact)
  end
